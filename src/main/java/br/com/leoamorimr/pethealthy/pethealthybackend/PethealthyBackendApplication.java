...
import br.com.leoamorimr.pethealthy.pethealthybackend.model.Cat;
import br.com.leoamorimr.pethealthy.pethealthybackend.model.Dog;
...
public class PethealthyBackendApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pet pet1 = new Dog(null, "Mel", "Preto/Marrom", LocalDate.of(2009, Month.FEBRUARY, 1), TipoPet.DOG, person1);
        Pet pet2 = new Dog(null, "Gaia", "Caramelo", LocalDate.of(2015, Month.MAY, 1), TipoPet.DOG, person2);
        Pet pet3 = new Dog(null, "Kim", "Preto/Marrom", LocalDate.of(2020, Month.JULY, 1), TipoPet.DOG, person2);
        Pet pet4 = new Cat(null, "Lili", "Preto/Branco", LocalDate.of(2020, Month.JULY, 1), TipoPet.CAT, person2);
